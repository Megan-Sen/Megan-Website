        ...
        <div className="cyf-work">
          {/* <div>
            <p className="works-title">
              Projects at CODE YOUR FUTURE 2021 - 2022
            </p>
          </div> */}
          <div className="cards-container">
            <a
              href="https://sensational-life-asd.herokuapp.com/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://tv-show-project-cyf.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              <div className="work-card">
            ...
            <a
              href="https://cakeshop-website.netlify.app"
              target="_blank"
              rel="noreferrer"
            >
              <div className="work-card">
